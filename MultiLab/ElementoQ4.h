...
class Elemento4 :public Elementos
{
public:
	Elemento4(int px, int py);
	~Elemento4();
...
inline Elemento4::Elemento4(int px, int py) : Elementos(px, py)
{
	x = px;
	y = py;
	dx = 0;
...
inline Elemento4::~Elemento4()
{

}

inline void Elemento4::CargarImagen(string pnombre_archivo)
{
...
inline void Elemento4::MoverImagen(Graphics^ lienzo)
{
	if (x > 1 || x < 800)
	{
		indiceFilas = indiceColumnas = 3;
	}
...
inline void Elemento4::MostrarImagen(Graphics^ lienzo)
{
...
inline void Elemento4::setX(int valor) {
	x = valor;
}
inline void Elemento4::setY(int valor) {
	y = valor;
}

inline int Elemento4::getX()
{
	return x;
}
inline int Elemento4::getY()
{
	return y;
}
inline int Elemento4::getW()
{
	return W;
}
inline int Elemento4::getH()
{
	return H;
}